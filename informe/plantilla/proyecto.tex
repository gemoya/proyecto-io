...
\begin{abstract}
\boldmath Se resolverá ``The Rehearsal Problem'', problema que trata sobre la asignación de músicos de una orquesta, a distinta piezas de ensayos, cada pieza tiene una duración distinta, donde los músicos que no tocan deben esperar que los otros músicos finalicen de tocar la pieza. Se busca minimizar el tiempo de espera entre cada pieza. \textbf{(5 ptos.)}
\end{abstract}
